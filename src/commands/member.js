  ...
  if (args.length <= 0) {
    ...
    (async () => {
      ...
      try {
        ...
        await client.query('INSERT INTO reminders(discord_id, reminder, created_at) VALUES($1, $2, NOW())',
          [uid, information]);
...
module.exports.help = {
  ...
  description: 'The bot members the information you pass. If no information given, your reminders are displayed.',
};
